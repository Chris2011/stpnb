...
import de.stpnb.stpnb.antlr.AntlrCharStream;
...
public class SilverstripeLexer implements Lexer<SilverstripeTokenId>{
    ...
    private static final Logger LOG = Logger.getLogger(SilverstripeLexer.class.getSimpleName());
    final private StpLexer lexer;

    final private LexerRestartInfo<SilverstripeTokenId> lri;
